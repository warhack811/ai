# -*- coding: utf-8 -*-
"""
services/pipeline.py - BASİTLEŞTİRİLMİŞ VERSİYON
------------------------------------------------
✅ Retry mekanizması KALDIRILDI
✅ Quality validator PASIF
✅ Sadece temizlik yapılıyor
"""
...
async def process_chat(request: ChatRequest) -> ChatResponse:
    """
    BASİTLEŞTİRİLMİŞ PIPELINE - Retry ve Quality Check YOK
    """
    ...
    # ============================================
    # PHASE 5: MODEL GENERATION (TEK DENEMEDE)
    # ============================================
    ...
    # ============================================
    # PHASE 6: OUTPUT CLEANING (SADECE TEMİZLİK)
    # ============================================
    
    cleaned_answer = output_cleaner.clean(raw_answer, model_key)
    
    # ⚠️ Quality validation KALDIRILDI - Direkt kabul et
    quality_score = 1.0  # Her zaman geçerli kabul et
    
    logger.info(f"✨ Cleaned output: {len(cleaned_answer)} chars")
    
    # ============================================
    # PHASE 7: SAFETY FILTER (Opsiyonel)
    # ============================================
